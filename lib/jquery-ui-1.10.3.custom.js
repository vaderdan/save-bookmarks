    ...
    $.widget("ui.draggable", $.ui.mouse, {
        ...
        _mouseDrag: function(event, noPropagation) {
            ...
            if (!this.options.axis || this.options.axis !== "y") {
                if (this.options.position == 'relative')
                    this.helper[0].style.marginLeft = this.position.left + "px";
                else
                    this.helper[0].style.left = this.position.left + "px";
            }
            if (!this.options.axis || this.options.axis !== "x") {
                if (this.options.position == 'relative')
                    this.helper[0].style.marginTop = this.position.top + "px";
                else
        ...
        _getRelativeOffset: function() {
            ...
            if (this.cssPosition === "relative") {
                ...
                if (this.options.position == 'relative') {
                    return {
                        top: p.top - (parseInt(this.helper.css("margin-top"), 10) || 0) + this.scrollParent.scrollTop(),
                        left: p.left - (parseInt(this.helper.css("margin-left"), 10) || 0) + this.scrollParent.scrollLeft()
                    };
                } else {
                    return {
        ...
        _cacheMargins: function() {
            this.margins = {
                left: (parseInt(this.element.css("margin-left"), 10) || 0),
                top: (parseInt(this.element.css("margin-top"), 10) || 0),
                right: (parseInt(this.element.css("margin-right"), 10) || 0),
                bottom: (parseInt(this.element.css("margin-bottom"), 10) || 0)
            };
        },
